...
public class UserRestServiceImpl implements UserRestService {
   ...
   @Override
    ...
    public String checkConditions(StaffDTO staff) {
        ...
        if (!hasCapital) {
            message += "Password harus terdiri atas setidaknya 1 kapital; ";
        }

        if (!hasDigit) {
            message += "Password harus terdiri atas setidaknya 1 angka; ";
        }

        if (!hasLetter) {
            message += "Password harus terdiri atas setidaknya 1 huruf; ";
        }
